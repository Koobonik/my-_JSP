	...
	<div class="container">
		<div class="row">
			<form method="post" action="writeAction.jsp">
				...
				<tr>
					<td>
						<input type="text" class="form-control" placeholder="글 제목" name="inflearn_JSPTitle" maxlength="50"></td>
					</tr>
					
					<tr>
						<td><textarea type="text" class="form-control" placeholder="글 내용" name="inflearn_JSPContent" maxlength="2048" style="height: 350px;"></textarea></td>
					</tr>
					</tbody>
			</table>
